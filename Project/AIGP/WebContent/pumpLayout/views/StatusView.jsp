...
<script src="${pageContext.request.contextPath}/pumpLayout/plugins/iCheck/icheck.min.js" type="text/javascript"></script>
 ...
 <script type="text/javascript">
        ...
        setTimeout(function(){ computeChargeLeft(); }, rateOfChange);
        ...
        $('input[type="checkbox"].flat-red, input[type="radio"].flat-red').iCheck({
	     ...
	     var reserviorRefilled = function(){
	    	 $.ajax({
	     ...
	     var refreshReserviorStatus = function()
	     {
	    	 $('reserviorLeftInput').val(100).trigger('change');
        	 $('#reserviorLeftInputUnit').val(100 + " units");
        	 $('#insulinConsumed').val(0).trigger('change');
        	 $('#insulinConsumedUnit').val(0 + "units");
	     }
		  	      ...
		  	      data : {
		  	        ...
		  	        success: function(data) {
		  	        	if(data != null && data != "")
		  	        	{
		  	        		...
		  	        		$('#reserviorLeftInputUnit').val(reserviorLevel+" units");
		  	        		$('#insulinConsumed').val(insulinConsumed).trigger('change');
		  	        		$('#insulinConsumedUnit').val(insulinConsumed+" units");
		  	        		var alterReserviorIcon = parent.iframe1.contentWindow.alterReserviorIcon;
		  	        		if(alterReserviorIcon != null)
		  	        			{
		  	        				alterReserviorIcon();
		  	        			}
		  	        	}
